...
const CompanyPanel = () => {
    ...
    return (
        <>
            {userCompany.length === 0 && <p className='company__empty-panel'>Brak zarejestrowanych firm. Moderator ma możliwość edycji oraz usuwania firm które zostały dodane przez niego.</p>}
            {userCompany.map(el => (
